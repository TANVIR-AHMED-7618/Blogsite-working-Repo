    ...
    <div class="bodyPart">
        ...
        <div class="mainPart">
            ...
            <div class="cartpart">
                <div class="cart1">
                    <h1>58</h1>
                    <h2>Total Blog Post</h2>
                </div>

                <div class="cart2">
                    <h1>24</h1>
                    <h2>Post of this Month</h2>
                </div>

                <div class="cart3">
                    <h1>17</h1>
                    <h2>Total Blog Writer</h2>
                </div>

                <div class="cart4">
                    <h1>137</h1>
                    <h2>Total Website Visitor</h2>
                </div>
            </div>
            ...
            <div class="tablel">
                ...
                <table class="cont-table">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Kolkata Tour Blog in August</td>
                            <td>Travel Blog</td>
                            <td>Tanvir Ahmed</td>
                            <td>20:47; 20 August, 2025</td>
                            <td><a href="#"><i class="fa-solid fa-pen-to-square"></i>Edit</a></td>
                            <td><a href="#"><i class="fa-solid fa-trash-xmark"></i>Delete</a></td>
                        </tr>

                        <tr>
                            <td>2</td>
                            <td>Windows 11 new update</td>
                            <td>IT Blog</td>
                            <td>Mamun Joy</td>
                            <td>11:31; 14 August, 2025</td>
                            <td><a href="#"><i class="fa-solid fa-pen-to-square"></i>Edit</a></td>
                            <td><a href="#"><i class="fa-solid fa-trash-xmark"></i>Delete</a></td>
                        </tr>
                        ...
                        <tr>
                            <td>3</td>
                            <td>Q&Q Watch gives casul look for man</td>
                            <td>Lifestyle Blog</td>
                            <td>Jahidul Islam</td>
                            <td>02:17; 23 August, 2025</td>
                            <td><a href="#"><i class="fa-solid fa-pen-to-square"></i>Edit</a></td>
                            <td><a href="#"><i class="fa-solid fa-trash-xmark"></i>Delete</a></td>
                        </tr>
                        ...
                        <tr>
                            <td>4</td>
                            <td>New investment needs for businesmen</td>
                            <td>Business Blog</td>
                            <td>Nahirul Islam</td>
                            <td>10:15; 19 August, 2025</td>
                            <td><a href="#"><i class="fa-solid fa-pen-to-square"></i>Edit</a></td>
                            <td><a href="#"><i class="fa-solid fa-trash-xmark"></i>Delete</a></td>
                        </tr>
                        ...
                        <tr>
                            <td>5</td>
                            <td>Kashmir tour in winter</td>
                            <td>Travel Blog</td>
                            <td>Tamim Iqbal</td>
                            <td>07:25; 20 August, 2025</td>
                            <td><a href="#"><i class="fa-solid fa-pen-to-square"></i>Edit</a></td>
                            <td><a href="#"><i class="fa-solid fa-trash-xmark"></i>Delete</a></td>
                        </tr>
                    </tbody>
